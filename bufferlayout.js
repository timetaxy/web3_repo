...
const dataSchema = [{
    ...
    {
        name: 'creatorAddress2',
        type: 'publickey',
    },
    {
        name: 'creatorVerified2',
        type: 'u8',
    },
    {
        name: 'creatorShare2',
    ...
    {
        name: 'creatorAddress3',
        type: 'publickey',
    },
    {
        name: 'creatorVerified3',
        type: 'u8',
    },
    {
        name: 'creatorShare3',
    ...
    {
        name: 'creatorAddress4',
        type: 'publickey',
    },
    {
        name: 'creatorVerified4',
        type: 'u8',
    },
    {
        name: 'creatorShare4',
...
const getSchemaData = (dataSchema, data) => {
    try {
        ...
        for (let schema of dataSchema) {
            ...
            switch (schema.type) {
                ...
                case "u16":
                    ...
                    break
                case "bool":
                    buffer.push(bufferlayout.u8(newName))
                    break
                case "option":
                ...
                case "utf8":
                    ...
                    break
                case "struct":
                    buffer.push(new bufferlayout.Structure([
        ...
        console.log('layoutDecoded', layoutDecoded)
